...
<Steps>
  <Step title="Navigate to Multi-Factor Authentication">
    In your [Protekt Dashboard](/mfa//sms/sms-configuration), go to the **Multi-Factor Authentication** settings page.
  </Step>
...
🎉 Your application is now configured for SMS MFA! Next, implement the [frontend integration](/mfa/sms/sms-frontend-integration) to allow users to enroll and verify their phone numbers.
